...
export default function ReplyPost({ post, setPost, replyInput }) {
  //Redux
      ...
      .then(() => {
        ...
        api
          ...
          .then((response) => {
            ...
            setPost({ ...post, posts: [response.data.post, ...post.posts] });
          })
          .catch((err) => {
            Swal.fire({
              icon: "error",
    ...
    <div className="py-3 flex items-center">
      ...
      <div className="ml-3 flex-1">
        <div className="border-gray-600">
          <div
            className={`${
              typing ? "block" : "flex items-center justify-between"
            }`}
          >
            <div>
              <div className={`${typing ? "block" : "hidden"}`}>
                <p className="">
                  Replying to{" "}
                  <Link
        ...
        <div className={`${typing ? "flex justify-between" : "hidden"} pt-2`}>
          <div className="flex">
            <label
              className={`${
